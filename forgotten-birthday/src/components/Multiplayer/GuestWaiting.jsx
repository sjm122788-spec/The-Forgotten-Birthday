  ...
  return (
    <main className="multiplayer-guest-waiting">
      <section className="multiplayer-guest-waiting__card">
        ...
        <h1 className="multiplayer-guest-waiting__title">{started ? "The story has begun" : "Waiting for the host"}</h1>
        <p className="multiplayer-guest-waiting__copy">
          {started
            ? "The story has begun. Watch the television. Your phone will wake when the story needs you."
